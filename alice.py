...
def main():
    ...
    print(f"✓ Verification with Alice's public key: {result} (should be 1)")
    ...
    with open('alice_to_bob.json', 'w') as f:
    ...
    print(f"\n✓ Alice verifies Bob's signature: {verification_result} (should be 1)")
    ...
    with open('alice_message_to_bob.json', 'w') as f:
